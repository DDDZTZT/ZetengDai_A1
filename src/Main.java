...
public class Main {
    ...
    private static void test(){
        ...
        // get doctor
        HealthProfessional gp1 = doctors.get(0);   // GP001 Dr. Smith
        HealthProfessional gp2 = doctors.get(1);   // GP002 Dr. Johnson
        HealthProfessional pd1 = doctors.get(3); // PD001 Dr. Wilson
        HealthProfessional pd2 = doctors.get(4); // PD002 Dr. Davis

        // create 2 GP appointment
        System.out.println("\n--- Creating 2 GP Appointments ---");
        createAppointment("Alice", "13811112222", "09:30", gp1);
        createAppointment("Bob", "13933334444", "14:15", gp2);

        // create 2 PD appointment
        System.out.println("\n--- Creating 2 PD Appointments ---");
        createAppointment("Charlie", "13755556666", "10:00", pd1);
        createAppointment("Diana", "13677778888", "15:45", pd2);
        ...
        // cancel
        System.out.println("\n--- Canceling Appointment (Mobile: 13811112222) ---");
        cancelBooking("13811112222");
